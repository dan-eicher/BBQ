...
void TablesEmitter::emit_opcode_tables_c(FILE* out) {
    ...
    fprintf(out,
        "/* AUTO-GENERATED by opgen — do not edit. */\n"
        "/* Source: the opcode spec (.def). */\n\n"
        /* The header opgen writes beside this file, by its own name: a
         * generated file that spelled a consumer's directory into its
         * include would only build for the consumer it was spelled for. */
        "#include \"opcodes.h\"\n\n");
